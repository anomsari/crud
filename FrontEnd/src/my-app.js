...
class MyApp extends PolymerElement {
      ...
      <app-drawer-layout fullbleed="" narrow="{{narrow}}">
        ...
        <app-drawer id="drawer" slot="drawer" swipe-open="[[narrow]]">
          ...
          <iron-selector selected="[[page]]" attr-for-selected="name" class="drawer-list" role="navigation">
            ...
            <a name="matakuliah" href="[[rootPath]]matakuliah">Matakuliah</a>
        ...
        <app-header-layout has-scrolling-region="">
          ...
          <iron-pages selected="[[page]]" attr-for-selected="name" role="main">
            ...
            <my-matakuliah name="matakuliah"></my-matakuliah>
  ...
  static get observers() {
    return [
      ...
      '_mahasiswaChanged(mahasiswaData)'
    ];
  }

  _mahasiswaChanged(page){
    if (!page) {
      this.page = 'view1';
    } else if (['view1', 'view2', 'view3','view4','mahasiswa','matakuliah','nilai'].indexOf(page) !== -1) {
      this.page = page;
    } else {
      this.page = 'view404';
    }
  ...
  _pageChanged(page) {
    ...
    switch (page) {
      ...
      case 'view4':
        ...
        break;
     case 'mahasiswa':
        import('./my-mahasiswa.js');
        break;
     case 'matakuliah':
        import('./my-matakuliah.js');
        break;
    case 'nilai':
        import('./my-nilai.js');
        break;
